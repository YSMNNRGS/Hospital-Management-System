...
public class NewJPanel extends JFrame {
    ...
    public NewJPanel() {
        ...
        HomeBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (UserAuthenticator.authenticate(username, password)) {
                    ...
                    NewJPanel.this.dispose();
                    
                    // Open the Home page (e.g., HomeGUI)
                    HomeGUI homeFrame = new HomeGUI();
                    homeFrame.setVisible(true);
                } else {
                    // Show an error message if login fails
                    JOptionPane.showMessageDialog(NewJPanel.this, "Invalid username or password.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        HomeBtn.setIcon(new ImageIcon("C:\\Users\\nargi\\Downloads\\Hospital System related icons - png\\login.png"));
        ...
        usernamee.setIcon(new ImageIcon("C:\\Users\\nargi\\Downloads\\Hospital-Management-backgrounds-icons\\LoginPage.png"));
